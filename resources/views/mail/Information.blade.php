...
<body style=" padding-left: 20%; padding-top: 3px; background-color:#f4f4f4">
    <table style="width: 600px; height: 100%; border-radius: 7px; box-shadow: 2px 0 16px -4px rgba(116, 116, 116,
        0.16); background-color: #ffffff; padding-bottom: 25px">
        <tbody>
            <br>
            <tr>
            ...
            <tr>
                <td colspan="4" style="padding-left: 52px; padding-right: 52px;">
                    <h1 style="font-size: 24px; color: #353535; font-weight: 600;font-stretch: normal; font-style:
                        normal; line-height: normal; letter-spacing: 1.54px; text-align: center;">Titulo</h1>
                </td>
            </tr>
            <tr>
                <td colspan="4" style="padding-left: 52px; padding-right: 52px;">
            ...
            <tr>
                <td colspan="4" style="padding-left: 52px; padding-right: 52px; font-size: 9px; font-size: 9px;
            ...
            <tr>
                <td>
                    <p style="text-align:center; font-size: 9px; font-weight: normal; font-stretch: normal;
                        ...
                        center;">Provaltec SpA. Todos los derechos reservados.
                </td>
            </tr>
        </tbody>
    </table>
